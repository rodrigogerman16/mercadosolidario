                ...
                <div className="mx-auto max-w-md">
                    ...
                    <form className="mt-6">
                        <div className="relative max-w-lg">
                            ...
                            <button className="absolute top-1/2 right-1 -translate-y-1/2  bg-pink-400 px-5 py-3 text-sm font-medium text-white transition hover:bg-pink-300" type="button">
                                Suscribirse
                            </button>
                        </div>
                    </form>
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                    <div className="mx-auto max-w-sm lg:max-w-none">
                        <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">
                            Somos una organizacion sin fines de lucro que busca facilitar la conexion entre ONG's, voluntarios y donantes.
                        </p>
