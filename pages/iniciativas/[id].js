                ...
                <div class="relative w-full h-full max-w-2xl md:h-auto">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                Una vez que sepas todos los datos para ser voluntario, deberás dirigirte al lugar de encuentro con el representante de la ONG, el cual te dirá que escanees un codigo QR, lo escanearas con el lector el cual se encuentra <a className='text-pink-400' target = '_blank' href='https://mercadosolidario.vercel.app/perfil/qr'>en esta sección</a>. Cuando lo escanees y salgo todo correcto, se confirmará tu participación en esta causa y podrás verlo en la sección 'iniciativas'. Además se te otorgará una medalla al confirmar tu participación la cual verás en tu perfil y te llegará un Email informandote de tu actualizacion de perfil.  
                            </p>
                        </div>
