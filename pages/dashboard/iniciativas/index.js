          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100">
                ...
                <span className="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-pink-400 bg-pink-100 rounded-full d">{props.inbox.length}</span>
              </a>
            </li>
            <li>
